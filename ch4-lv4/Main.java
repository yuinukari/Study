...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // service.registerClient(new Client("CLI-003", "株式会社スマートオフィス", ...));
        ...
        Invoice inv2 = new Invoice("INV-2026-0002", "CLI-002", LocalDate.of(2026, 5, 25), LocalDate.of(2026, 7, 15));
        inv2.addDetail(new InvoiceDetail("D004", "INV-2026-0002", "コンサルティング料", 3, 150000));

        Invoice inv3 = new Invoice("INV-2026-0003", "CLI-003", LocalDate.of(2026, 5, 25), LocalDate.of(2026, 6, 15));
        ...
        service.printMonthlyReport();
        service.printSortedByDueDate();
    }
}